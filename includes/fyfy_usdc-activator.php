...
class fyfycoin_Activator {
    ...
    public static function activate() {
        ...
        global $wpdb;
        $tableName = $wpdb->prefix . 'fyfy_usdc_payment';
        ...
        $purchase_page = get_page_by_title(fyfy_Payment_PROCESS);
        if ( empty( $purchase_page ) ) {
            // Checkout Page
            $checkout = wp_insert_post(
                array(
                    'post_title'     => __( fyfy_Payment_PROCESS, 'pl8app' ),
                    'post_content'   => '[fyfy_payment_proceed_page]',
                    'post_status'    => 'publish',
                    'post_author'    => 1,
                    'post_type'      => 'page',
